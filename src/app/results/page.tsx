...
/**
 * `/results` — no longer the hand-off target of block 15, and no longer a dead
 * end either.
 *
 ...
 * `src/lib/site-gate/gate.ts:103` lists `/results` in `OPEN_PAGES`, and
  ...
  return (
    <main className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center gap-4 px-6 py-16">
      ...
      <p className="text-base text-ink-muted">
        Terminaste las quince. Entra a la sala y elige cómo quieres conectar.
      </p>

/**
 * Where a participant resumes (docs/domain.md §0 as amended by D18).
 *
 ...
 */
import { isDeclaredComplete, type Participant } from "./participant";

export type IntakeStep = "register" | "declared" | "quiz";
...
export function intakeStepOf(participant: Participant | null): IntakeStep {
  ...
  if (
    participant.declaredAt === null &&
    !isDeclaredComplete(participant.declared)
  ) {
    return "declared";
  }
  return "quiz";
